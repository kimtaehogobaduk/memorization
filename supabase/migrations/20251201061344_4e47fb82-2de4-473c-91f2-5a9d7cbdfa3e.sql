-- Add quiz font size setting to user_settings
ALTER TABLE public.user_settings 
ADD COLUMN quiz_font_size TEXT DEFAULT 'medium' CHECK (quiz_font_size IN ('small', 'medium', 'large'));
...
BEGIN
  ...
  IF NEW.email = 'csiahabitmakers@naver.com' THEN
...
BEGIN
  ...
  FROM auth.users
  WHERE email = 'csiahabitmakers@naver.com';
